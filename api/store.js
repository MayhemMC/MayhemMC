module.exports = async function(req, res) {
	...
	packages.push({
		name: "VIP",
		display_prefix: "&2[&aVIP&2]",
		expires: false,
		price: 2.50,
		features: (await fs.readFile(path.join(__dirname, "../docs/dperks", "vip.md"), "utf8")),
	...
	packages.push({
		name: "Warrior",
		display_prefix: "&3[&bWARRIOR&3]",
		expires: false,
		price: 7.50,
		features: (await fs.readFile(path.join(__dirname, "../docs/dperks", "warrior.md"), "utf8")),
	...
	packages.push({
		name: "Hero",
		display_prefix: "&5[&dHERO&5]",
		expires: false,
		price: 15.00,
		features: (await fs.readFile(path.join(__dirname, "../docs/dperks", "hero.md"), "utf8")),
	...
	packages.push({
		name: "Legend",
		display_prefix: "&6[&eLEGEND&6]",
		expires: false,
		price: 25.00,
		features: (await fs.readFile(path.join(__dirname, "../docs/dperks", "legend.md"), "utf8")),
