module.exports = async function(req, res) {
	...
	function isOnSale() {
		if(today > new Date("11/26/2020") && today < new Date("11/28/2020")) return true;
		if(today > new Date("12/23/2020") && today < new Date("01/02/2021")) return true;
		return false;
	}
